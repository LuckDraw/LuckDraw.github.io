  ...
  <article class="home-page-wrapper">
    <section class="main">
      <div>
        ...
        <h1 style="margin: 1.8rem auto; max-width: 36rem; line-height: 2.4rem">基于 Js / JQuery / Vue / 微信小程序 / uni-app 的抽奖插件【大转盘 & 九宫格】</h1>
        <div class="plugin">
          <div>
...
.home-page-wrapper .plugin>div h1 {
  font-size: 18px;
  color: #1f2f3d;
  font-weight: 400;
}
.home-page-wrapper .plugin>div p {
  font-size: 14px;
  color: #99a9bf;
  padding: 0 25px;
  line-height: 20px;
...
@media (max-width: 719px) {
  ...
  .home-page-wrapper .plugin>div:nth-child(n+3) {
    display: none;
  }
}
